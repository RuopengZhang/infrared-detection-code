...
if __name__ == '__main__':
    ...
    model = YOLO("./cfg/models/v8/yolov8-IR-downsample.yaml")  # 从头开始构建新模型
    ...
    results = model.train(data="./dataset/HIT_UAV_downsample_6/HIT_UAV_downsample_6.yaml", epochs=200, batch=16, workers=8, close_mosaic=0, name='HIT_UAV_downsample_train')  # 训练模型
